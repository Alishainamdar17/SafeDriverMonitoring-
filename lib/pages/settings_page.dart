        ...
        body: ListView(
          ...
          children: [
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  _settings = Settings(
                    ...
                    adaptiveLearningEnabled: _settings.adaptiveLearningEnabled,
                  );
                });
              },
            ),
            ...
            _buildSettingSection(
              ...
              max: 30,
              divisions: 25,
              valueLabel: '${_settings.minDrivingSpeed.toStringAsFixed(0)} km/h',
              onChanged: (value) {
                setState(() {
                  _hasChanges = true;
                  _settings = Settings(
            ...
            _buildSettingSection(
              ...
              max: 130,
              divisions: 70,
              valueLabel: '${_settings.speedLimit.toStringAsFixed(0)} km/h',
              onChanged: (value) {
                setState(() {
                  _hasChanges = true;
                  _settings = Settings(
            ...
            SwitchListTile(
              ...
              subtitle: const Text(
                  'Personalize alerts from driving history',
                  style: TextStyle(color: Colors.white70)),
              value: _settings.adaptiveLearningEnabled,
            ...
            _buildSettingSection(
              ...
              divisions: 40,
              valueLabel:
                  '${_settings.suddenAccThreshold.toStringAsFixed(1)} m/s²',
              onChanged: (value) {
                setState(() {
                  _hasChanges = true;
                  _settings = Settings(
            ...
            _buildSettingSection(
              ...
              divisions: 40,
              valueLabel:
                  '${_settings.suddenBrakeThreshold.abs().toStringAsFixed(1)} m/s²',
              onChanged: (value) {
                setState(() {
                  _hasChanges = true;
                  _settings = Settings(
            ...
            _buildSettingSection(
              ...
              divisions: 40,
              valueLabel:
                  '${_settings.sharpTurnThreshold.toStringAsFixed(1)} m/s²',
              onChanged: (value) {
                setState(() {
                  _hasChanges = true;
                  _settings = Settings(
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TelegramSetupPage()),
                  );
                },
                child: const Text(
